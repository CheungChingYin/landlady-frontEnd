export default {
  ...
  'user.login.mobile.placeholder': '请输入手机号码',
  ...
  'user.register.name.placeholder': '姓名',
  ...
  'user.label.form.name': '姓名',
  'user.label.form.email': '邮箱地址',
  'user.label.form.phoneNumber': '手机号',
  'user.label.form.password': '密码',
  'user.label.form.passwordConfirm': '再次确认密码',
  'user.label.form.isFreeze': '是否冻结',
