export default {
  ...
  'contract.label.form.rentStartDate': '租赁开始时间',
  'contract.label.form.rentEndDate': '租赁结束时间',
  ...
  'contract.label.form.rentStartDate.required': '租赁开始时间必填',
  'contract.label.form.rentEndDate.required': '租赁结束时间必填',
  'contract.label.form.receiptDate.required': '每月收款日必填',
  'contract.label.form.contractStatus.required': '合同状态必填'
}
